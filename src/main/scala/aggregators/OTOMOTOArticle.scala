...
//  photoDownloadLinks.foreach(savePhotosToDrive)


  def toSeq: Seq[Any] = Seq(id, date, title, articleLink, location, yearKilometrageFueltypeBodytype, details, equipment, description)
